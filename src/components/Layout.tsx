...
import { BookOpen, Code2, Settings, FileText, Shield, FlaskConical, GraduationCap, Layers, Briefcase, Zap, Trophy, LayoutDashboard, Brain, StickyNote, Target } from 'lucide-react';
...
function NavLink({ to, icon: Icon, label, activePath }: { to: string; icon: React.ElementType; label: string; activePath?: string }) {
...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex transition-colors duration-200">
      {/* Sidebar */}
      <aside className="w-72 bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 flex flex-col fixed h-full transition-colors duration-200">
        {/* Logo */}
